local Translations = {
    ...
    commands = {
        place_spike = 'Place Spike Strip (Sheriff, Ranger, Marshal Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (Sheriff, Ranger, Marshal Only)',
        cuff_player = 'Cuff Player (Sheriff, Ranger, Marshal Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (Sheriff, Ranger, Marshal Only)',
        jail_player = 'Jail Player (Sheriff, Ranger, Marshal Only)',
        unjail_player = 'Unjail Player (Sheriff, Ranger, Marshal Only)',
        clearblood = 'Clear The Area of Blood (Sheriff, Ranger, Marshal Only)',
        seizecash = 'Seize Cash (Sheriff, Ranger, Marshal Only)',
        softcuff = 'Soft Cuff (Sheriff, Ranger, Marshal Only)',
        camera = 'View Security Camera (Sheriff, Ranger, Marshal Only)',
        flagplate = 'Flag A Plate (Sheriff, Ranger, Marshal Only)',
        unflagplate = 'Unflag A Plate (Sheriff, Ranger, Marshal Only)',
        plateinfo = 'Run A Plate (Sheriff, Ranger, Marshal Only)',
        depot = 'Impound With Price (Sheriff, Ranger, Marshal Only)',
        impound = 'Impound A Vehicle (Sheriff, Ranger, Marshal Only)',
        paytow = 'Pay Tow Driver (Sheriff, Ranger, Marshal Only)',
        paylawyer = 'Pay Lawyer (sheriff, Judge Only)',
        anklet = 'Attach Tracking Anklet (Sheriff, Ranger, Marshal Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (Sheriff, Ranger, Marshal Only)',
        drivinglicense = 'Seize Drivers License (Sheriff, Ranger, Marshal Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (Sheriff, Ranger, Marshal Only)',
