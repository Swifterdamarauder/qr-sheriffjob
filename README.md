...
- [qb-bossmenu](https://github.com/QRCore-framework/qb-bossmenu) - For the boss menu
- [qb-garages](https://github.com/QRCore-framework/qb-garages) - For the vehicle spawner
- [qb-clothing](https://github.com/QRCore-framework/qb-clothing) - For the locker room
- [qb-phone](https://github.com/QRCore-framework/qb-phone) - For the MEOS app and notifications etc.
- [qb-log](https://github.com/QRCore-framework/qb-logs) - For logging certain events
- [qb-menu](https://github.com/QRCore-framework/qb-menu) - For the vehicle menus
- [qb-input](https://github.com/QRCore-framework/qb-input) - For accessing evidence stashes
